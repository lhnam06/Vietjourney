      ...
      <header className="h-16 bg-gradient-to-r from-[var(--vj-primary)] to-[var(--vj-primary-2)] border-b border-[var(--vj-border)]">
        <div className="h-full max-w-[1400px] mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-full bg-white/10 border border-white/15 flex items-center justify-center text-[var(--vj-text-on-dark)] font-bold">
              V
            </div>
            <div className="flex items-center gap-2">
              <span className="text-[var(--vj-text-on-dark)] font-bold tracking-wide">VIETJOURNEY</span>
              <span className="text-xs text-[var(--vj-text-on-dark-muted)]">🇻🇳</span>
            </div>
          </div>
