...
export function TimelineEditor({
  ...
  return (
    <main className="min-w-0 flex-1 overflow-hidden bg-[linear-gradient(135deg,oklch(0.99_0.004_280),oklch(0.965_0.014_277))] px-4 pb-4 pt-8 lg:px-5">
      <div className="grid h-[calc(100vh-3rem)] min-h-0 gap-4 xl:grid-cols-[360px_minmax(0,1fr)]">
        ...
        <section className="flex min-h-0 min-w-0 flex-col rounded-2xl border border-border bg-card p-5 shadow-sm">
          ...
          <div
            className="relative mt-4 min-h-0 flex-1 overflow-y-auto overflow-x-hidden rounded-2xl border border-border bg-white"
...
function TimelineCard({
  ...
  return (
    <article
      ...
      onDragStart={onDragStart}
      className={cn(
        "group pointer-events-auto absolute z-20 flex cursor-grab items-center justify-center overflow-hidden rounded-xl border border-primary/25 bg-[linear-gradient(135deg,oklch(0.94_0.045_277),oklch(0.985_0.018_277))] px-2 py-1.5 text-center text-xs shadow-sm transition hover:z-30 hover:border-primary/40 hover:shadow-md active:cursor-grabbing",
        saving ? "opacity-60" : "",
      )}
